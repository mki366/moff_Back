...
DROP TABLE CONSULTINGT
CASCADE CONSTRAINTS;

SELECT * FROM CONSULTING;

CREATE TABLE CONSULTINGT(
	CONNUM	NUMBER			NULL,   -- 신청순서
	ID		VARCHAR2(20)	NULL,		--신청아이디
	PHONE	VARCHAR2(20)	NULL,
	MESS		 VARCHAR2(100) NULL,	--간편상담메세지
	CONDATE DATE NULL 					--신청날짜
);
