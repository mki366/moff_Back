...
public class DeliDto {
	...
	public DeliDto(int memNum, String id, String pwd, String name, String nickname, String email, String address,
	...
	public DeliDto(String id, String pwd, String name, String nickname, String email, String address, String phone,
			String bdate) {
		super();
		this.id = id;
		this.pwd = pwd;
